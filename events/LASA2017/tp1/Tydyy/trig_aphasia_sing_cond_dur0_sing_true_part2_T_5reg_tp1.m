...
fnames=aux(3:end,:);
for sub=16
    %sub1(ID102) some base and singm false; sub2(ID104)all trials correct;
    %sub3(ID106) some lis and base false, sub4(ID109) some base && singm false, all
    %lis false, sub5(ID110) all trials correct, sub6(ID112) some base &&
    %lis false, sub7(ID113) all trials correct, sub8(ID114) some singa &&
    %singm false, sub9(ID116) some base, lis, singa && singm false,
    %sub10(ID121) some singa false, sub11(ID122) some lis and singm false,
    %sub12(ID123) some base, singa & singm false, sub13(ID124) some lis,
    %singa && singm false, sub14(ID127) some lis, base, singa && singm
    %false, sub15(ID128) some lis false, sub16(ID134) some lis && base
    %false
