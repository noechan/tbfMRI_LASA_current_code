clear all
file_path='/Users/noeliamartinezmolina/Documents/ds220j_drive_macbook/temp/Aphasia_project/events/';
data_path='/Volumes/LASA/Aphasia_project/Recordings/LASA2017/Noise_reduction/Uulaa/';
% aux= ls(file_path);
% fnames=aux(3:end,:);
fnames='ID104';

for sub=1
    %sub1(ID102) some base, lis and singm false, sub2(ID104) some lis and singa false, sub3(ID106) all trials correct  
    ...sub4(ID109) some base,singa & singm false & all lis false,
    ...sub5(ID110)some base, lis & singm false, sub6(ID112) some singa false,
    ...sub7(ID113) all trials correct, sub8(ID114) some lis, base& singm false, sub9(ID116) some lis, base, singa & singm false
    ...sub10(ID121) some lis false, sub11(ID122) some lis, singa & singm false,
    ...sub12(ID123) some singa & singm false, sub13(ID124) some lis, base, singa & singm false, 
    ...sub14(ID127) some lis, base, singa & singm false, sub15(ID128) some lis false
    ...sub16(ID134) some singa & singm false
    ...
    %sub_path2=fullfile(file_path,(fnames(sub,:)),[(fnames(sub,:)) '_1'], 'func','Triggers');
    cd (sub_path1)
