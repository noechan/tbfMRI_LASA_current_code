...
for sub=16
    %sub1(ID102) some singa & singm false, sub2(ID104) some singa and singm false, sub3(ID106) all trials correct  
    ...sub4(ID109) some base & all lis false,
    ...sub5(ID110) all trials correct, sub6(ID112) all trial correct,
    ...sub7(ID113) all trials correct, sub8(ID114) some singa & singm false, sub9(ID116) some lis false
    ...sub10(ID121) some singm false, sub11(ID122) some lis, base, singa & singm false,
    ...sub12(ID123) some singm false, sub13(ID124) some lis & singm false, 
    ...sub14(ID127) some lis, base, singa & singa false, sub15(ID128) some lis, base & singm false
    ...sub16(ID134) some lis false
...
if sub~=3 && sub~=5 && sub ~=6 && sub~=7
  ...
  if sub~=3 && sub~=4 && sub~=5 && sub~=6 && sub~=7
  ...
  elseif sub==3  || sub==5 || sub==6  || sub==7
