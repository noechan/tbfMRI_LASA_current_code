...
%List patients cohort 2019 session 2
aux= ls(source_path);
names=aux([3 5:9 11:16],:); %ID136 aborted, ID143 excluded, ID154 && ID155 && ID157 PPA, ID158 dropout
...
for n=2:length(names)
    ...
    sub_path1=fullfile(source_path, (names(n,:)), [(names(n,:)) '_2'], 'Triggers');
    cd(sub_path1)
