...
for sbj = 1:numel(subjects)
    ...
    % Specify contrasts weights
        ...
        matlabbatch{1}.spm.stats.con.consess{1}.tcon.weights = [0 0 0 0 zeros(1,outliers_Tydyy) 1 -1 0 0 0 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{3}.tcon.weights = [1 -1 0 0 zeros(1,outliers_Tydyy) 0 1 -1 0 0 zeros(1,outliers_Uulaa)];
        matlabbatch{1}.spm.stats.con.consess{3}.tcon.sessrep = 'none';
        
        matlabbatch{1}.spm.stats.con.consess{4}.tcon.name = 'Sing_mem>sing_along';
        matlabbatch{1}.spm.stats.con.consess{4}.tcon.weights = [-1 1 0 0 zeros(1,outliers_Tydyy) 0 -1 1 0 0 zeros(1,outliers_Uulaa)];
        matlabbatch{1}.spm.stats.con.consess{4}.tcon.sessrep = 'none';
        
        matlabbatch{1}.spm.stats.con.consess{5}.tcon.name = 'Sing_along>listen';
        matlabbatch{1}.spm.stats.con.consess{5}.tcon.weights = [0 0 0 0 zeros(1,outliers_Tydyy) -1 1 0 0 0 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{7}.tcon.weights = [0 0 0 0 zeros(1,outliers_Tydyy) 1 0 0 -1 0 zeros(1,outliers_Uulaa)];
        matlabbatch{1}.spm.stats.con.consess{7}.tcon.sessrep = 'none';
        
        matlabbatch{1}.spm.stats.con.consess{8}.tcon.name = 'Sing_along>baseline';
        matlabbatch{1}.spm.stats.con.consess{8}.tcon.weights = [1 0 -1 0 zeros(1,outliers_Tydyy) 0 1 0 -1 0 zeros(1,outliers_Uulaa)];
        matlabbatch{1}.spm.stats.con.consess{8}.tcon.sessrep = 'none';
        
        matlabbatch{1}.spm.stats.con.consess{9}.tcon.name = 'Sing_mem>baseline';
        matlabbatch{1}.spm.stats.con.consess{9}.tcon.weights = [0 1 -1 0 zeros(1,outliers_Tydyy) 0 0 1 -1 0 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{12}.tcon.name = 'Sing_along>baseline Tydyy';
        ...
        matlabbatch{1}.spm.stats.con.consess{13}.tcon.name = 'Sing_mem>baseline Tydyy';
