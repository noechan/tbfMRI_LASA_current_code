...
for sbj = 1:numel(subjects)
    ...
    % Specify contrasts weights
        ...
        matlabbatch{1}.spm.stats.con.consess{1}.tcon.weights = [1 -1 0 zeros(1,outliers_Tydyy) 1 -1 0 zeros(1,outliers_Uulaa)];
        matlabbatch{1}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
        
        matlabbatch{1}.spm.stats.con.consess{2}.tcon.name = 'Sing_mem>sing_along';
        matlabbatch{1}.spm.stats.con.consess{2}.tcon.weights = [-1 1 0 zeros(1,outliers_Tydyy) -1 1 0 zeros(1,outliers_Uulaa)];
        matlabbatch{1}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
        
        matlabbatch{1}.spm.stats.con.consess{3}.tcon.name = 'Sing_along> sing_mem Tydyy';
        matlabbatch{1}.spm.stats.con.consess{3}.tcon.weights = [1 -1 0 zeros(1,outliers_Tydyy) 0 0 0 zeros(1,outliers_Uulaa)];
        matlabbatch{1}.spm.stats.con.consess{3}.tcon.sessrep = 'none';
        
        matlabbatch{1}.spm.stats.con.consess{4}.tcon.name = 'Sing_mem>sing_along Tydyy';
        matlabbatch{1}.spm.stats.con.consess{4}.tcon.weights = [-1 1 0 zeros(1,outliers_Tydyy) 0 0 0 zeros(1,outliers_Uulaa)];
        matlabbatch{1}.spm.stats.con.consess{4}.tcon.sessrep = 'none';
        
        matlabbatch{1}.spm.stats.con.consess{5}.tcon.name = 'Sing_along> sing_mem Uulaa';
        matlabbatch{1}.spm.stats.con.consess{5}.tcon.weights = [0 0 0 zeros(1,outliers_Tydyy) 1 -1 0 zeros(1,outliers_Uulaa)];
        matlabbatch{1}.spm.stats.con.consess{5}.tcon.sessrep = 'none';
        
        matlabbatch{1}.spm.stats.con.consess{6}.tcon.name = 'Sing_mem>sing_along Uulaa';
        matlabbatch{1}.spm.stats.con.consess{6}.tcon.weights = [0 0 0 zeros(1,outliers_Tydyy) -1 1 0 zeros(1,outliers_Uulaa)];
