...
for sbj = 1:numel(subjects)
    ...
    % Specify contrasts weights
        ...
        matlabbatch{1}.spm.stats.con.consess{7}.tcon.name = 'Listen>sing_along Tydyy';
        matlabbatch{1}.spm.stats.con.consess{7}.tcon.weights = [1 -1 0 0 zeros(1,outliers_Tydyy) 0 0 0 0 zeros(1,outliers_Uulaa)];
        matlabbatch{1}.spm.stats.con.consess{7}.tcon.sessrep = 'none';
        
        matlabbatch{1}.spm.stats.con.consess{8}.tcon.name = 'Listen>sing_mem Tydyy';
        matlabbatch{1}.spm.stats.con.consess{8}.tcon.weights = [1 0 -1 0 zeros(1,outliers_Tydyy) 0 0 0 0 zeros(1,outliers_Uulaa)];
        matlabbatch{1}.spm.stats.con.consess{8}.tcon.sessrep = 'none';
        
        matlabbatch{1}.spm.stats.con.consess{9}.tcon.name = 'Sing_along> sing_mem Tydyy';
        matlabbatch{1}.spm.stats.con.consess{9}.tcon.weights = [0 1 -1 0 zeros(1,outliers_Tydyy) 0 0 0 0 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{10}.tcon.weights = [0 -1 1 0 zeros(1,outliers_Tydyy) 0 0 0 0 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{11}.tcon.weights = [-1 1 0 0 zeros(1,outliers_Tydyy) 0 0 0 0 zeros(1,outliers_Uulaa)];
        matlabbatch{1}.spm.stats.con.consess{11}.tcon.sessrep = 'none';
        
        matlabbatch{1}.spm.stats.con.consess{12}.tcon.name = 'Sing_mem>listen Tydyy';
        matlabbatch{1}.spm.stats.con.consess{12}.tcon.weights = [-1 0 1 0 zeros(1,outliers_Tydyy) 0 0 0 0 zeros(1,outliers_Uulaa)];
