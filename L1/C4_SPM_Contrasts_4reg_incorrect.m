...
for sbj = 1:numel(subjects)
    ...
    % Specify contrasts weights
        ...
        matlabbatch{1}.spm.stats.con.consess{13}.tcon.weights = [0 -1 1 0 zeros(1,outliers_Tydyy) 0 0 0 0 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{14}.tcon.weights = [-1 1 0 0 zeros(1,outliers_Tydyy) 0 0 0 0 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{15}.tcon.weights = [-1 0 1 0 zeros(1,outliers_Tydyy) 0 0 0 0 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{16}.tcon.weights = [1 0 0 -1 zeros(1,outliers_Tydyy) 0 0 0 0 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{17}.tcon.weights = [0 1 0 -1 zeros(1,outliers_Tydyy) 0 0 0 0 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{18}.tcon.weights = [0 0 1 -1 zeros(1,outliers_Tydyy) 0 0 0 0 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{19}.tcon.weights = [0 0 0 0 zeros(1,outliers_Tydyy) 1 -1 0 0 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{20}.tcon.weights = [0 0 0 0 zeros(1,outliers_Tydyy) 1 0 -1 0 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{21}.tcon.weights = [0 0 0 0 zeros(1,outliers_Tydyy) 0 1 -1 0 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{22}.tcon.weights = [0 0 0 0 zeros(1,outliers_Tydyy) 0 -1 1 0 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{23}.tcon.weights = [0 0 0 0 zeros(1,outliers_Tydyy) -1 1 0 0 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{24}.tcon.weights = [0 0 0 0 zeros(1,outliers_Tydyy) -1 0 1 0 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{25}.tcon.weights = [0 0 0 0 zeros(1,outliers_Tydyy) 1 0 0 -1 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{26}.tcon.weights = [0 0 0 0 zeros(1,outliers_Tydyy) 0 1 0 -1 zeros(1,outliers_Uulaa)];
        ...
        matlabbatch{1}.spm.stats.con.consess{27}.tcon.weights = [0 0 0 0 zeros(1,outliers_Tydyy) 0 0 1 -1 zeros(1,outliers_Uulaa)];
