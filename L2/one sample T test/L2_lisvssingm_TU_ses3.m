...
L2_folder='listening_vs_singm_TU_ses3';
%% Prepare inputs
n=1;
for sbj = 1:size(subjects_s3, 1) %Dataset from session 3
    disp(subjects(sbj).name)
    sub_path= fullfile(subjects_s3(sbj).folder, subjects_s3(sbj).name, ses, der,L1, L1_folder);
