...
p.addParameter('L2folder', 'singm_vs_singa_TU_wo_3_14_19_27_28', @ischar)
...
matlabbatch{1}.spm.tools.snpm.des.PairT.fsubject(n).scans =  vertcat(con_fnames_pre(sbj,1), con_fnames_post(sbj,1));
