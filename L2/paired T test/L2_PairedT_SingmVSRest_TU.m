...
p.addParameter('L2folder', 'singm_vs_ rest_TU', @ischar)
...
for sbj = 1:size(subjects, 1)
    ...
    con_pre{sbj,1}=spm_select('List', fullfile(sub_path_pre), '^con_0009.*\.nii$');
    ...
    con_post{sbj,1}=spm_select('List', fullfile(sub_path_post), '^con_0009.*\.nii$');
