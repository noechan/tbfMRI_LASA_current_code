function L2_PairedT_ListenVSRest_Untrained_age(subjects, outdir, varargin)
...
p.addParameter('L2folder', 'listen_vs_rest_Untrained_Age_wo_motion_outliers', @ischar)
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'Listen vs Rest Untrained AB/BA Pre vs Post';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [1 -1];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'Listen vs Rest Untrained AB/BA Post vs Pre';
