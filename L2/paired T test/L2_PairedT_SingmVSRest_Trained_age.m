...
p.addParameter('L2folder', 'singm_vs_rest_Trained_Age_wo_motion_outliers', @ischar)
...
% Input age covariate:
if ~isempty(idx_Age), subjects(idx_Age)=[]; end
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'Sing mem vs Rest Trained AB/BA Pre vs Post';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [1 -1];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'Sing mem vs Rest Trained AB/BA Post vs Pre';
