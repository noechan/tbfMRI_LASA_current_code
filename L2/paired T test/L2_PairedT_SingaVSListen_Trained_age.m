...
p.addParameter('L2folder', 'singa_vs_listen_Trained_Age_wo_motion_outliers_wo_14', @ischar)
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'Sing along vs Listen Trained AB/BA Pre vs Post';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [1 -1];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'Sing along vs Listen Trained AB/BA Post vs Pre';
