...
p.addParameter('L2folder', 'listen_vs_singa_Trained_Age_wo_motion_outliers_wo_14', @ischar)
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'Listen vs Sing along Trained AB/BA Pre vs Post';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [1 -1];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'Listen vs Sing along Trained AB/BA Post vs Pre';
