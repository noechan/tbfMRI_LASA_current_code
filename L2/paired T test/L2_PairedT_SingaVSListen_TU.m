...
p.addParameter('L2folder', 'singa_vs_ listen_TU', @ischar)
...
for sbj = 1:size(subjects, 1)
    ...
    con_pre{sbj,1}=spm_select('List', fullfile(sub_path_pre), '^con_0005.*\.nii$');
    ...
    con_post{sbj,1}=spm_select('List', fullfile(sub_path_post), '^con_0005.*\.nii$');
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'Sing along vs Listen TU AB/BA Pre vs Post';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [1 -1];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'Sing along vs Listen TU AB/BA Post vs Pre';
