function L2_PairedT_SingaVSRest_Untrained_age(subjects, outdir, varargin)
%L2_PairedT_SingaVSRest_Untrained_age
%----------------------------------------------------------------------------------------
...
p.addParameter('L2folder', 'singa_vs_rest_Untrained_Age_wo_motion_outliers_wo_14', @ischar)
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'Sing along vs Rest Untrained AB/BA Pre vs Post';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [1 -1];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'Sing along vs Rest Untrained AB/BA Post vs Pre';
