...
p.addParameter('L2folder', 'listen_vs_ singm_TU', @ischar)
...
for sbj = 1:size(subjects, 1)
    ...
    con_pre{sbj,1}=spm_select('List', fullfile(sub_path_pre), '^con_0002.*\.nii$');
    ...
    con_post{sbj,1}=spm_select('List', fullfile(sub_path_post), '^con_0002.*\.nii$');
