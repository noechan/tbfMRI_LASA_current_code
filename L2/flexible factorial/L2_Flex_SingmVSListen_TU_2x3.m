...
p.addParameter('L2folder', 'singm_vs_listen_TU_2by3', @ischar)
...
%         %scans session 1
%         con_ses1{sbj,1}=spm_select('List', fullfile(sub_path, Arg.ses1, Arg.derdir,Arg.L1dir, Arg.L1folder), '^con_0006.*\.nii$');
%         con_fnames_ses1{sbj,1}=fullfile(sub_path, Arg.ses1, Arg.derdir,Arg.L1dir, Arg.L1folder, con_ses1{sbj,1});
%         %scans session 2
%         con_ses2{sbj,1}=spm_select('List', fullfile(sub_path, Arg.ses2, Arg.derdir,Arg.L1dir, Arg.L1folder), '^con_0006.*\.nii$');
%         con_fnames_ses2{sbj,1}=fullfile(sub_path, Arg.ses2, Arg.derdir,Arg.L1dir, Arg.L1folder, con_ses2{sbj,1});
%         %scans session 3
%         con_ses3{sbj,1}=spm_select('List', fullfile(sub_path, Arg.ses3, Arg.derdir,Arg.L1dir, Arg.L1folder), '^con_0006.*\.nii$');
