...
p.addParameter('L2folder', 'listen_vs_ rest_TU_2by3_sortgr', @ischar)
...
for sbj = 1:size(subjects, 1)
    ...
    if subjects(sbj).group==1
        %scans session 1
        con_ses1_g1{g1,1}=spm_select('List', fullfile(sub_path, Arg.ses1, Arg.derdir,Arg.L1dir, Arg.L1folder), '^con_0007.*\.nii$');
        con_fnames_ses1_g1{g1,1}=fullfile(sub_path, Arg.ses1, Arg.derdir,Arg.L1dir, Arg.L1folder, con_ses1_g1{g1,1});
        %scans session 2
        con_ses2_g1{g1,1}=spm_select('List', fullfile(sub_path, Arg.ses2, Arg.derdir,Arg.L1dir, Arg.L1folder), '^con_0007.*\.nii$');
        con_fnames_ses2_g1{g1,1}=fullfile(sub_path, Arg.ses2, Arg.derdir,Arg.L1dir, Arg.L1folder, con_ses2_g1{g1,1});
        %scans session 3
        con_ses3_g1{g1,1}=spm_select('List', fullfile(sub_path, Arg.ses3, Arg.derdir,Arg.L1dir, Arg.L1folder), '^con_0007.*\.nii$');
        con_fnames_ses3_g1{g1,1}=fullfile(sub_path, Arg.ses3, Arg.derdir,Arg.L1dir, Arg.L1folder, con_ses3_g1{g1,1});
        g1=g1+1;
    elseif subjects(sbj).group==2
        %scans session 1
        con_ses1_g2{g2,1}=spm_select('List', fullfile(sub_path, Arg.ses1, Arg.derdir,Arg.L1dir, Arg.L1folder), '^con_0007.*\.nii$');
        con_fnames_ses1_g2{g2,1}=fullfile(sub_path, Arg.ses1, Arg.derdir,Arg.L1dir, Arg.L1folder, con_ses1_g2{g2,1});
        %scans session 2
        con_ses2_g2{g2,1}=spm_select('List', fullfile(sub_path, Arg.ses2, Arg.derdir,Arg.L1dir, Arg.L1folder), '^con_0007.*\.nii$');
        con_fnames_ses2_g2{g2,1}=fullfile(sub_path, Arg.ses2, Arg.derdir,Arg.L1dir, Arg.L1folder, con_ses2_g2{g2,1});
        %scans session 3
        con_ses3_g2{g2,1}=spm_select('List', fullfile(sub_path, Arg.ses3, Arg.derdir,Arg.L1dir, Arg.L1folder), '^con_0007.*\.nii$');
        con_fnames_ses3_g2{g2,1}=fullfile(sub_path, Arg.ses3, Arg.derdir,Arg.L1dir, Arg.L1folder, con_ses3_g2{g2,1});
        g2=g2+1;
    end
end

    n1=1; n2=1;
        for i=1:numel(con_ses1_g1)
        matlabbatch{1}.spm.stats.factorial_design.des.fblock.fsuball.fsubject(n1).scans = vertcat(con_fnames_ses1_g1(i,1), con_fnames_ses2_g1(i,1), con_fnames_ses3_g1(i,1));
        matlabbatch{1}.spm.stats.factorial_design.des.fblock.fsuball.fsubject(n1).conds = [1 1; 1 2; 1 3];
        n1=n1+1;
        end
        for j=1:numel(con_ses1_g2)
        matlabbatch{1}.spm.stats.factorial_design.des.fblock.fsuball.fsubject(n1-1+n2).scans = vertcat(con_fnames_ses1_g2(j,1), con_fnames_ses2_g2(j,1), con_fnames_ses3_g2(j,1));
        matlabbatch{1}.spm.stats.factorial_design.des.fblock.fsuball.fsubject(n1-1+n2).conds = [2 1; 2 2; 2 3];
        n2=n2+1;
        end
