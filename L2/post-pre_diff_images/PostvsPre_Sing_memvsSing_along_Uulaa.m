function PostvsPre_Sing_memvsSing_along_Uulaa(subjects, outdir, varargin)
%PostvsPre_Sing_memvsSing_along_Uulaa
%----------------------------------------------------------------------------------------
...
for sbj = 1:size(subjects, 1)
    ...
    if ~isempty(con_idx_pre) && ~isempty(con_idx_post)
        ...
        matlabbatch{n}.spm.util.imcalc.output =['Sing_mem>sing_along_Uulaa_Post>Pre_' subjects(sbj).name];
