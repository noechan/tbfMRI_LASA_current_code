function PostvsPre_Sing_alongvsBaseline_TU(subjects, outdir, varargin)
...
for sbj = 1:size(subjects, 1)
    ...
    if ~isempty(con_idx_pre) && ~isempty(con_idx_post)
        ...
        matlabbatch{n}.spm.util.imcalc.output =['Sing_along>baseline_Post>Pre_' subjects(sbj).name];
