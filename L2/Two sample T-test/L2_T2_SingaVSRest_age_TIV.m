function L2_T2_SingaVSRest(subjects, outdir, varargin)
%L2_T2_SingaVSRest
%----------------------------------------------------------------------------------------
...
p.addParameter('L2folder', 'singa_vs_rest_age_TIV_BRAVEvsLASA_wo_motion_outliers', @ischar)
...
for sbj = 1:size(subjects, 1)
    ...
    if subjects(sbj).group==1
        ...
        con_idx_LASA=find(ismember({SPM.xCon.name}, {'Sing_along>baseline'}));
    ...
    elseif subjects(sbj).group==2
        ...
        con_idx_BRAVE=find(ismember({SPM.xCon.name}, {'Sing_along>baseline'}));
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'BRAVE vs LASA Sing along vs baseline ses-1';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [-1 1];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'LASA vs BRAVE Sing along vs baseline ses-1';
