...
idx_motion_outliers=find(ismember({LASA_subjects.name},{'sub-03','sub-19','sub-27','sub-28'}));
...
% Load cov file
cd(cov_dir); [num,txt,raw] =xlsread('LASA_group_BIDS_wo3_19_27_28.xlsx',1, 'A1:E25');
...
L2_T2_LisVSRest_age_TIV(subjects_baseline,outdir)
L2_T2_LisVSSingm_age_TIV(subjects_baseline,outdir)
L2_T2_SingmVSRest_age_TIV(subjects_baseline,outdir)
L2_T2_SingmVSListen_age_TIV(subjects_baseline,outdir)
