function L2_T2_SingaVSSingm(subjects, outdir, varargin)
%L2_T2_SingaVSSingm
%----------------------------------------------------------------------------------------
...
p.addParameter('L2folder', 'singa_vs_singm_age_TIV_BRAVEvsLASA_wo_motion_outliers', @ischar)
...
for sbj = 1:size(subjects, 1)
    ...
    if subjects(sbj).group==1
        ...
        con_idx_LASA=find(ismember({SPM.xCon.name}, {'Sing_along> sing_mem'}));
    ...
    elseif subjects(sbj).group==2
        ...
        con_idx_BRAVE=find(ismember({SPM.xCon.name}, {'Sing_along> sing_mem'}));
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'BRAVE vs LASA Sing along vs sing_mem ses-1';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [-1 1];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'LASA vs BRAVE Sing along vs sing_mem ses-1';
